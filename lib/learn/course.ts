...
export const COURSE: Module[] = [
  {
    ...
    lessons: [
      ...
      {
        id: "big-three",
        title: { en: "Reading the Big Three together", pt: "Lendo o Grande Trio em conjunto" },
        paragraphs: [
          { en: "Sun, Moon and Ascendant are three different questions. The Sun asks 'who am I becoming?' — the direction of the life. The Moon asks 'what do I need to feel safe?' — the instinctive, private self. The Ascendant asks 'how do I arrive?' — the body, the style, the first impression.",
            pt: "Sol, Lua e Ascendente são três perguntas diferentes. O Sol pergunta 'quem estou me tornando?' — a direção da vida. A Lua pergunta 'do que preciso para me sentir seguro?' — o eu instintivo e privado. O Ascendente pergunta 'como eu chego?' — o corpo, o estilo, a primeira impressão." },
          { en: "The art is in the combination. A Pisces Sun with a Capricorn Moon dreams big but self-soothes through structure and work; put a Capricorn Ascendant in front and the world meets discipline first, poetry later. Contradictions between the three are not flaws — they are the person's inner conversation.",
            pt: "A arte está na combinação. Um Sol em Peixes com Lua em Capricórnio sonha grande mas se acalma por estrutura e trabalho; ponha um Ascendente em Capricórnio na frente e o mundo encontra a disciplina primeiro, a poesia depois. Contradições entre os três não são defeitos — são a conversa interna da pessoa." },
          { en: "Exercise: write one sentence per point, then a fourth sentence that lets them negotiate. 'I am becoming X, I need Y, I arrive as Z — so my work is to let Y feed X without hiding behind Z.' That fourth sentence is a reading.",
            pt: "Exercício: escreva uma frase por ponto, e uma quarta frase em que eles negociam. 'Estou me tornando X, preciso de Y, chego como Z — então meu trabalho é deixar Y alimentar X sem me esconder atrás de Z.' Essa quarta frase é uma leitura." },
        ],
        takeaways: [
          { en: "Sun = direction; Moon = needs; Ascendant = arrival.", pt: "Sol = direção; Lua = necessidades; Ascendente = chegada." },
          { en: "Contradictions are the inner conversation, not errors.", pt: "Contradições são a conversa interna, não erros." },
          { en: "One sentence each + one synthesis sentence = a reading.", pt: "Uma frase para cada + uma frase de síntese = uma leitura." },
        ],
        quiz: {
          question: { en: "Which point describes the first impression you give?", pt: "Qual ponto descreve a primeira impressão que você causa?" },
          options: [
            { en: "The Sun", pt: "O Sol" },
            { en: "The Moon", pt: "A Lua" },
            { en: "The Ascendant", pt: "O Ascendente" },
  ...
  },
  {
    ...
    lessons: [
      ...
      {
        id: "moon-phases",
        title: { en: "Moon phases & the lunar month", pt: "Fases da Lua & o mês lunar" },
        paragraphs: [
          { en: "The phase is simply the angle between Moon and Sun. New Moon: they conjoin — a dark sky, a blank page. First Quarter: 90° apart — the first friction of action. Full Moon: opposition — full light, full sight. Last Quarter: the closing square — release and clearing.",
            pt: "A fase é simplesmente o ângulo entre Lua e Sol. Lua Nova: conjunção — céu escuro, página em branco. Quarto Crescente: 90° — a primeira fricção da ação. Lua Cheia: oposição — luz plena, visão plena. Quarto Minguante: a quadratura de fechamento — soltar e limpar." },
          { en: "The month is a project cycle: seed at the New, adjust at the First Quarter, harvest and see clearly at the Full, compost at the Last. You do not need belief to use it — a 29.5-day cadence for starting, correcting, showing and finishing is simply good rhythm.",
            pt: "O mês é um ciclo de projeto: semeie na Nova, ajuste no Crescente, colha e enxergue na Cheia, composte no Minguante. Não é preciso crença para usar — uma cadência de 29,5 dias para começar, corrigir, mostrar e encerrar é simplesmente bom ritmo." },
          { en: "One refinement: the SIGN of the New or Full Moon shows the flavor of the chapter, and the HOUSE it falls in (in your chart) shows the arena. A Full Moon in your 10th is a public culmination; in your 4th, a domestic one.",
            pt: "Um refinamento: o SIGNO da Lua Nova ou Cheia mostra o sabor do capítulo, e a CASA em que ela cai (no seu mapa) mostra a arena. Uma Lua Cheia na sua casa 10 é culminação pública; na 4, doméstica." },
        ],
        takeaways: [
          { en: "Phase = Moon–Sun angle; the month is a project cycle.", pt: "Fase = ângulo Lua–Sol; o mês é um ciclo de projeto." },
          { en: "New = seed; Full = see; Quarters = adjust and release.", pt: "Nova = semear; Cheia = ver; Quartos = ajustar e soltar." },
          { en: "Sign flavors the chapter; your natal house locates it.", pt: "O signo dá o sabor; sua casa natal dá o lugar." },
        ],
        quiz: {
          question: { en: "The Full Moon is which Sun–Moon aspect?", pt: "A Lua Cheia é qual aspecto Sol–Lua?" },
          options: [
            { en: "Conjunction", pt: "Conjunção" },
            { en: "Square", pt: "Quadratura" },
            { en: "Opposition", pt: "Oposição" },
            { en: "Trine", pt: "Trígono" },
          ],
  ...
  },
  {
    ...
    lessons: [
      ...
      {
        id: "house-overlays",
        title: { en: "House overlays — where they land in your life", pt: "Sobreposição de casas — onde a pessoa cai na sua vida" },
        paragraphs: [
          { en: "Beyond aspects, lay the other person's planets into YOUR houses. Their Sun in your 7th makes them feel like a partner; in your 10th, like an ally of your ambitions; in your 12th, like a mystery you can't quite hold.",
            pt: "Além dos aspectos, projete os planetas da outra pessoa nas SUAS casas. O Sol dela na sua casa 7 faz a pessoa parecer um par; na sua 10, um aliado das suas ambições; na sua 12, um mistério que você não consegue segurar." },
          { en: "The classics to watch: their Moon in your 4th (feels like family), their Venus in your 5th or 7th (romance and delight), their Saturn in your houses (where they bring weight, structure — or judgment), their Mars (where they energize or irritate you).",
            pt: "Os clássicos a observar: a Lua da pessoa na sua 4 (parece família), a Vênus dela na sua 5 ou 7 (romance e encanto), o Saturno dela nas suas casas (onde traz peso, estrutura — ou cobrança), o Marte (onde ela te energiza ou te irrita)." },
          { en: "Overlays are directional — their planets in your houses describe YOUR experience of them; the reverse describes theirs of you. When both directions light the same arena, that area becomes the relationship's home ground.",
            pt: "Sobreposições têm direção — os planetas da pessoa nas suas casas descrevem a SUA experiência dela; o inverso descreve a dela sobre você. Quando as duas direções acendem a mesma arena, essa área vira o território da relação." },
        ],
        takeaways: [
          { en: "Overlay = their planets in your houses.", pt: "Sobreposição = os planetas do outro nas suas casas." },
          { en: "Moon→4th, Venus→5th/7th, Saturn→weight, Mars→heat.", pt: "Lua→4ª, Vênus→5ª/7ª, Saturno→peso, Marte→calor." },
          { en: "Read both directions; shared arenas define the bond.", pt: "Leia as duas direções; arenas em comum definem o vínculo." },
        ],
        quiz: {
          question: { en: "Their Saturn in your 2nd house tends to bring…", pt: "O Saturno do outro na sua casa 2 tende a trazer…" },
          options: [
            { en: "Instant wealth", pt: "Riqueza instantânea" },
            { en: "Structure or pressure around money and worth", pt: "Estrutura ou pressão em torno de dinheiro e valor" },
            { en: "More travel", pt: "Mais viagens" },
            { en: "Nothing — Saturn only matters in aspects", pt: "Nada — Saturno só importa em aspectos" },
          ],
          answer: 1,
        },
      },
  ...
  },
  {
    ...
    lessons: [
      ...
      {
        id: "fools-journey",
        title: { en: "The Fool's Journey — the majors as a path", pt: "A Jornada do Louco — os maiores como caminho" },
        paragraphs: [
          { en: "Read 0–XXI as one story in three acts. Act I (I–VII): the world's teachers — Magician and Priestess (will and intuition), Empress and Emperor (nature and order), Hierophant, Lovers, Chariot (culture, choice, victory). The Fool learns to act.",
            pt: "Leia 0–XXI como uma história em três atos. Ato I (I–VII): os mestres do mundo — Mago e Sacerdotisa (vontade e intuição), Imperatriz e Imperador (natureza e ordem), Hierofante, Enamorados, Carro (cultura, escolha, vitória). O Louco aprende a agir." },
          { en: "Act II (VIII–XIV): the inner trial — Strength, Hermit, Wheel, Justice, Hanged Man, Death, Temperance. Mastery turns inward: patience, solitude, fate, accountability, surrender, ending, synthesis. The Fool learns to feel and to let go.",
            pt: "Ato II (VIII–XIV): a prova interior — Força, Eremita, Roda, Justiça, Enforcado, Morte, Temperança. A maestria vira para dentro: paciência, solitude, destino, responsabilidade, entrega, fim, síntese. O Louco aprende a sentir e a soltar." },
          { en: "Act III (XV–XXI): the great powers — Devil and Tower (bondage and collapse), Star, Moon, Sun (hope, the unconscious, clarity), Judgement and World (the call and the completion). When a spread leans on one act, the querent is living that act.",
            pt: "Ato III (XV–XXI): as grandes potências — Diabo e Torre (prisão e queda), Estrela, Lua, Sol (esperança, inconsciente, clareza), Julgamento e Mundo (o chamado e a conclusão). Quando uma tiragem pende para um ato, o consulente está vivendo aquele ato." },
        ],
        takeaways: [
          { en: "Majors = one journey in three acts.", pt: "Maiores = uma jornada em três atos." },
          { en: "Act I: acting; Act II: feeling/releasing; Act III: transforming.", pt: "Ato I: agir; Ato II: sentir/soltar; Ato III: transformar." },
          { en: "The dominant act in a spread locates the querent's chapter.", pt: "O ato dominante numa tiragem localiza o capítulo do consulente." },
        ],
        quiz: {
          question: { en: "Death (XIII) belongs to which act of the journey?", pt: "A Morte (XIII) pertence a qual ato da jornada?" },
          options: [
            { en: "Act I — the world's teachers", pt: "Ato I — os mestres do mundo" },
            { en: "Act II — the inner trial", pt: "Ato II — a prova interior" },
            { en: "Act III — the great powers", pt: "Ato III — as grandes potências" },
            { en: "None — it is outside the journey", pt: "Nenhum — está fora da jornada" },
          ],
          answer: 1,
        },
      },
