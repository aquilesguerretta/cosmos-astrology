  ...
  return (
    <div className="grid min-h-[60vh] w-full place-items-center px-6">
      <div className="max-w-md text-center">
        <p className="label-caps text-[var(--gold)]/80">{dict.errors.cloudedLabel}</p>
        <h2 className="font-display mt-2 text-3xl">{dict.errors.obscured}</h2>
        <p className="mt-3 text-sm text-[var(--text-secondary-color)]">
          {error.message || dict.errors.unexpected}
        </p>
        <button
          onClick={reset}
